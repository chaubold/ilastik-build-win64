...
if(WITH_OPENSSL)
    include (openssl)
    set(OPENSSL_DEPENDS ${openssl_NAME})
    set(OPENSSL_CONFIG perl -p -i.bak -e s/openssl-0.9.8l/${openssl_NAME}/g pyproject.props)
    set(OPENSSL_BUILD devenv PCbuild.sln /build "Release|${PYTHON_BITNESS}" /project _ssl)
else()
    set(OPENSSL_DEPENDS "")
    set(OPENSSL_CONFIG "")
    set(OPENSSL_BUILD "")
...
ExternalProject_Add(${python_NAME}
    DEPENDS             ${bzip2_NAME} ${OPENSSL_DEPENDS} ${nasm_NAME} # ${zlib_NAME}
